...
namespace LollipopUI.Controls {
  ...
  public class LollipopSmallCard : Control {
    ...
    protected override void OnPaint(PaintEventArgs e) {
      ...
      if (image != null) { G.DrawImage(image, 3, 3, 48, 47); }
      if (Enabled) { G.DrawString(Text, font.Roboto_Medium10, new SolidBrush(StringColor), new PointF(58.6f, 9f)); } else { G.DrawString("Wait...", font.Roboto_Medium10, new SolidBrush(StringColor), new PointF(58.6f, 9f)); }
